...
module Metrics
  ...
  # Application-specific metrics for CrystalShards Registry
  ...
  SEARCH_DURATION = REGISTRY.histogram("search_duration_seconds", "Search request duration in seconds")
  SHARD_SUBMISSIONS_TOTAL = REGISTRY.counter("shard_submissions_total", "Total shard submissions")
