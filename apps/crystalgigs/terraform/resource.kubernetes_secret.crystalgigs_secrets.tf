...
resource "kubernetes_secret" "crystalgigs_secrets" {
  ...
  data = {
    ...
    # Username matches bootstrap.initdb.owner from the cluster manifest ("crystalgigs")
    ...
    database_url = "postgresql://crystalgigs:${data.kubernetes_secret.crystalgigs_postgres_app.data["password"]}@crystalgigs-postgres-rw:5432/crystalgigs_production"
