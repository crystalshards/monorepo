...
module Metrics
  ...
  # Application-specific metrics for CrystalGigs
  ...
  PAYMENT_DURATION = REGISTRY.histogram("payment_duration_seconds", "Payment processing duration in seconds")
  PAYMENT_FAILURES_TOTAL = REGISTRY.counter("payment_failures_total", "Total payment processing failures")
  JOB_POSTINGS_TOTAL = REGISTRY.counter("job_postings_total", "Total job postings created")
