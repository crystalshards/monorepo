class Jobs::NewPage < MainLayout
  ...
  private def render_job_form
    tag "form", action: "/jobs", method: "post", class: "job-form" do
      render_basic_info
      render_job_details
      render_compensation
    ...
    fieldset do
      ...
      div class: "form-row" do
        ...
        div class: "form-group" do
          ...
          select name: "job:job_type", id: "job_job_type", required: true do
    ...
    fieldset do
      ...
      div class: "form-row" do
        ...
        div class: "form-group" do
          ...
          select name: "job:salary_currency", id: "job_salary_currency" do
