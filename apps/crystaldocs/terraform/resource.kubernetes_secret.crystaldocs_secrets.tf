...
resource "kubernetes_secret" "crystaldocs_secrets" {
  ...
  data = {
    ...
    # Username matches bootstrap.initdb.owner from the cluster manifest ("crystaldocs")
    ...
    database_url = "postgresql://crystaldocs:${data.kubernetes_secret.crystaldocs_postgres_app.data["password"]}@crystaldocs-postgres-rw:5432/crystaldocs_production"
  ...
  lifecycle {
    ...
    replace_triggered_by = [
      data.kubernetes_secret.crystaldocs_postgres_app.id,
