...
describe Newsletter::Subscribe do
  ...
  it "normalizes email to lowercase" do
    ApiClient.exec(Newsletter::Subscribe, email: "Test@EXAMPLE.COM")
  ...
  it "generates unique confirmation token" do
    ApiClient.exec(Newsletter::Subscribe, email: "test1@example.com")
    ApiClient.exec(Newsletter::Subscribe, email: "test2@example.com")
