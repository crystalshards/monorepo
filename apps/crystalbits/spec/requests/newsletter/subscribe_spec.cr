...
describe Newsletter::Subscribe do
  it "creates subscriber with valid email" do
    response = AppClient.exec(Newsletter::Subscribe, email: "test@example.com")

    response.should send_http_status(302) # Redirect
  ...
  it "normalizes email to lowercase" do
    AppClient.exec(Newsletter::Subscribe, email: "Test@EXAMPLE.COM")
  ...
  it "rejects invalid email format" do
    response = AppClient.exec(Newsletter::Subscribe, email: "not-an-email")
  ...
  it "requires email" do
    response = AppClient.exec(Newsletter::Subscribe, email: "")
  ...
  it "generates unique confirmation token" do
    AppClient.exec(Newsletter::Subscribe, email: "test1@example.com")
    AppClient.exec(Newsletter::Subscribe, email: "test2@example.com")
