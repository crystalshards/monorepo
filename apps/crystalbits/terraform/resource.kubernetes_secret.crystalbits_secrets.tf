...
resource "kubernetes_secret" "crystalbits_secrets" {
  ...
  data = {
    ...
    database_url = "postgresql://${data.kubernetes_secret.crystalbits_postgres_app.data["username"]}:${data.kubernetes_secret.crystalbits_postgres_app.data["password"]}@crystalbits-postgres-rw:5432/crystalbits_production"
