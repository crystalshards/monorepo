...
Lucky::Server.configure do |settings|
  if LuckyEnv.production?
    ...
    settings.secret_key_base = "2x6/lLkpG0rSlGoMihOcBZxCCGPltVK2SEGFvGsfrKY="
...
Lucky::ForceSSLHandler.configure do |settings|
  ...
  #
  # The gateway in front of this app terminates TLS itself, so leave it
  # disabled here until the deploy topology says otherwise.
