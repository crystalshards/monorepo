...
describe Shards::Browse::Index do
  it "renders browse page successfully" do
    response = ApiClient.exec(Shards::Browse::Index)
  ...
  it "searches shards by name" do
    ...
    response = ApiClient.exec(Shards::Browse::Index, query: "http")
  ...
  it "shows empty state when no shards found" do
    ...
    response = ApiClient.exec(Shards::Browse::Index, query: "nonexistent")
  ...
  it "displays search results count" do
    ...
    response = ApiClient.exec(Shards::Browse::Index, query: "test")
  ...
  it "handles pagination" do
    ...
    response = ApiClient.exec(Shards::Browse::Index, page: 1)
  ...
  it "shows previous link on page 2" do
    ...
    response = ApiClient.exec(Shards::Browse::Index, page: 2)
  ...
  describe "sorting" do
    it "sorts by popularity (GitHub stars)" do
      ...
      response = ApiClient.exec(Shards::Browse::Index, sort: "popular")
    ...
    it "sorts by name alphabetically" do
      ...
      response = ApiClient.exec(Shards::Browse::Index, sort: "name")
    ...
    it "sorts by total downloads" do
      ...
      response = ApiClient.exec(Shards::Browse::Index, sort: "downloads")
  ...
  describe "filtering" do
    it "filters by license" do
      ...
      response = ApiClient.exec(Shards::Browse::Index, license: "MIT")
    ...
    it "filters by minimum stars" do
      ...
      response = ApiClient.exec(Shards::Browse::Index, min_stars: 50)
    ...
    it "filters by has documentation" do
      ...
      response = ApiClient.exec(Shards::Browse::Index, has_docs: true)
    ...
    it "maintains filters across pagination" do
      ...
      response = ApiClient.exec(Shards::Browse::Index, license: "MIT", page: 2)
