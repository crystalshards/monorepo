...
# the package registry would refuse to serve a single page because a credential
# it has no use for was absent. That is the wrong failure: the blast radius of
# a missing mail key should be mail, not the site.
#
