...
export default defineConfig({
  ...
  webServer: [
    {
      command: 'cd ../../apps/shards-registry && crystal run src/crystalshards.cr',
      port: 3000,
    ...
    {
      command: 'cd ../../apps/shards-docs && crystal run src/crystaldocs.cr',
      port: 3001,
      reuseExistingServer: !process.env.CI,
      env: {
        NODE_ENV: 'test',
    ...
    {
      command: 'cd ../../apps/gigs && crystal run src/crystalgigs.cr',
      port: 3002,
      reuseExistingServer: !process.env.CI,
      env: {
        NODE_ENV: 'test',
